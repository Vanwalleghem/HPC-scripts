...
with open('CaImAn_array.sh','w') as the_file:
 ...
 job_string = 'filename=`ls -d '+base_folder+'/_*/ | tail -n +\${SLURM_ARRAY_TASK_ID} | head -1` \n'
 the_file.write(job_string) 
 ...
 job_string = 'python ~/VolumetricCaImAn1p_cropped.py $filename \n' 
 the_file.write(job_string)
