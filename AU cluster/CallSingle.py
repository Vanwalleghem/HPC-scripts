...
with open('Single_volume_ENS.sh','w') as the_file:
 ...
 job_string = 'python ~/Single_volume.py $filename \n' 
 the_file.write(job_string)


job_string = """sbatch Single_volume_ENS.sh""" 
print(job_string)
