...
np.save(os.path.join(tif_file_folder,os.path.basename(tif_file_folder).split('_range')[0]+'_Jacobian.npy'),Time_serie)
savemat(os.path.join(tif_file_folder,os.path.basename(tif_file_folder).split('_range')[0]+'_Jacobian.mat'),Time_serie)