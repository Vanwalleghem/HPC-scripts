...
greedy -d 3 -a -o ./${affine_c1_file} -i ${STANDARD_REFERENCE} ./${input_c1_file}  -n 100x40x20 -ia-image-centers -m MNI -V 2
printf "%s\n" "greedy -d 3 -float -o ./${warp_c1_file} -i ${STANDARD_REFERENCE} ./${input_c1_file}  -it ${affine_c1_file} -n 100x50x20 -e 0.25 -m NCC 2x2x2 -V 2"
greedy -d 3 -float -o ./${warp_c1_file} -i ${STANDARD_REFERENCE} ./${input_c1_file}  -it ${affine_c1_file} -n 100x50x20 -e 0.25 -m NCC 2x2x2 -V 2
