...
conda init
conda activate node
export LD_LIBRARY_PATH=/home/gillesv/miniforge3/envs/greedy/lib/
# Input variables

input_c0_file="optfixed/${file}_C0.nrrd"
input_c1_file="optfixed/${file}_C1.nrrd"
input_c2_file="optfixed/${file}_C2.nrrd"
bisxform_file="standard_ref__${file}_C1__optfixed__nlr.bisxform"
registered_c0_file="r_${file}_C0.nii.gz"
registered_c1_file="r_${file}_C1.nii.gz"
registered_c2_file="r_${file}_C2.nii.gz"
affine_c0_file="a_${file}_C0.nii.gz"
warp_c0_file="w_${file}_C0.nii.gz"
...
greedy -d 3 -rf ${STANDARD_REFERENCE} -rm \${input_c1_file} \${registered_c1_file} -r \${warp_c0_file} \${affine_c0_file}
#biswebnode resliceImage -r \${registered_c1_file} -i \${input_c0_file} -x \${bisxform_file} -o \${registered_c0_file}
greedy -d 3 -rf ${STANDARD_REFERENCE} -rm \${input_c0_file} \${registered_c0_file} -r \${warp_c0_file} \${affine_c0_file}
...
if [ -f \${input_c2_file} ]
then	
 greedy -d 3 -rf ${STANDARD_REFERENCE} -rm \${input_c2_file} \${registered_c2_file} -r \${warp_c0_file} \${affine_c0_file}
...
greedy -d 3 -jac \${warp_c0_file} \${jacobian_file}
