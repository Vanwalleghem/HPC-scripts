...
with open('CaImAnJacob_array.sh','w') as the_file:
 ...
 the_file.write('#SBATCH  --output=CaImAnJacob_%A_%a.out \n')
 ...
 job_string = 'python ~/caiman_extract_Jacobian.py $filename \n' 
 the_file.write(job_string)


job_string = """sbatch CaImAnJacob_array.sh""" 
print(job_string)
