...
with open('GreedyCheck.sh','w') as the_file:
 ...
 the_file.write('#SBATCH  --output=GreedyCheck_%A_%a.out \n')
 ...
 job_string = 'python ~/GreedyCheck.py $filename \n' 
 the_file.write(job_string)


job_string = """sbatch GreedyCheck.sh""" 
print(job_string)
